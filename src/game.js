import {AMENITY_STATES,initAmenities,tryStartAmenity,updateAmenity,cancelAmenity,repathAmenities,validateAmenities} from './amenities.js';
...
export class Game {
 ...
 static restore(data){
  ...
  validateAmenities(g);g.assignStaff();return g;
 }
}
